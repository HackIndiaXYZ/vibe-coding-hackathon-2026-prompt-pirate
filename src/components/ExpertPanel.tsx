    ...
    <div className="rounded-2xl border border-border bg-card/40 backdrop-blur-sm overflow-hidden">
      <div className="flex items-center justify-between gap-3 border-b border-border px-5 sm:px-6 py-4">
        <div className="min-w-0">
          ...
          <div className="font-display text-xl sm:text-2xl italic truncate">
            Six verdicts. One report.
          </div>
        </div>
      ...
      <div
        className="flex md:grid md:grid-cols-6 overflow-x-auto border-b border-border scrollbar-none snap-x snap-mandatory"
        ...
        {experts.map((e, i) => {
          ...
          return (
            <button
              ...
              className={`group relative shrink-0 md:shrink snap-start basis-[110px] md:basis-auto flex flex-col items-center gap-2 px-3 py-4 sm:py-5 border-r last:border-r-0 border-border transition-all ${
            ...
            >
              ...
              <div
                className="relative size-11 sm:size-12 rounded-full grid place-items-center border transition-all duration-300 group-hover:scale-105"
                style={{
              ...
              >
                ...
                {isActive && (
                  <span
                    className="absolute -bottom-0.5 -right-0.5 size-3 rounded-full ring-2 ring-card animate-pulse-glow"
              ...
              <div className="text-center">
                ...
                <div className="text-[9px] font-mono uppercase tracking-widest text-muted-foreground/70 truncate max-w-[90px]">
                  {e.name.split(" ")[0]}
                </div>
              </div>
            </button>
      ...
      <div key={active} className="p-5 sm:p-6 md:p-8 animate-rise">
        <div className="flex flex-col md:flex-row md:items-start gap-5 md:gap-6">
          <div className="md:w-48 shrink-0 space-y-3">
            <div
              className="aspect-square w-full max-w-[200px] mx-auto md:mx-0 rounded-xl border relative overflow-hidden"
              style={{
            ...
            >
              <activeExpert.icon
                className="absolute inset-0 m-auto size-16 sm:size-20 opacity-90"
                style={{ color: activeExpert.color }}
              />
              <div className="absolute bottom-0 inset-x-0 p-3 bg-gradient-to-t from-card via-card/80 to-transparent">
              ...
              {activeExpert.focus.map((f) => (
                ...
                >
                  <span
                    ...
                    style={{ background: activeExpert.color }}
                  />
                  {f}
                </div>
              ))}
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3">
              <span
                ...
                style={{
                  borderColor: `${activeExpert.color}55`,
                  color: activeExpert.color,
                  background: `${activeExpert.color}14`,
                }}
              >
                {activeFb.rating}
              </span>
            ...
            <h3 className="font-display text-2xl sm:text-3xl leading-tight tracking-tight mb-4">
              {activeFb.headline}
            </h3>
            <div className="relative pl-6 text-[14px] sm:text-[15px] leading-relaxed text-muted-foreground">
              <Quote
            ...
            {/* Focus chips on mobile */}
            <div className="md:hidden mt-4 flex flex-wrap gap-1.5">
              {activeExpert.focus.map((f) => (
                <span
                  key={f}
